...
## launches supernode on localhost, and range of nodes on localhost.. 
## no nat translation or communications outside of localhost are supported
## 
## takes 3 arguments
## 1st argument: port of new supernode to be launched
...
## each node will be communicating with the newly launched supernode
